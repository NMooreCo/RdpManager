...
namespace RdpManager.Models
{
    public class Credential : IDisposable
    {
        ...
        public bool Save()
        {
            ...
            if (Password == null)
            {
                throw new ArgumentOutOfRangeException("The password cannot be null.");
            }
            ...
            bool result = NativeMethods.CredWrite(ref credential, default);
            if (!result)
            {
                return false;
            }
        ...
        public bool Load()
        {
            ...
            bool result = NativeMethods.CredRead(Target, Type, 0, out var credPointer);
            if (!result)
            {
                return false;
            }
